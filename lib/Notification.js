...
var Notification = function (_React$Component) {
  ...
  function Notification() {
    ...
    }, _this.mapAlertTypeToIconName = function (alertType) {
      return {
        success: 'tick',
        info: 'market-value',
  ...
  _createClass(Notification, [{
    ...
    value: function render() {
      ...
      var className = (0, _classnames2.default)(['alert', 'alert-' + (type === 'error' ? 'danger' : type)]);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('i', { className: 'connect-icon connect-icon-' + this.mapAlertTypeToIconName(type), 'aria-hidden': 'true' })
        ),
        _react2.default.createElement(
          'div',
          { className: 'alert-text', role: 'alert' },
          _react2.default.createElement(
            'h2',
            null,
            title
